    ...
    <div className={styles.container}>
      ...
      <div className="wrapper">
        ...
        <div className="sidebar">
          ...
          <ul>
            <li>
              <a href="#second-section" className="bebas sidebar-item">Our Master Blender</a>
            </li>
            <li>
              <a href="#fourth-section" className="bebas sidebar-item">Products</a>
            </li>
            <li>
              <a href="#sixth-section" className="bebas sidebar-item">Grain To Glass</a>
            </li>
            <li>
              <a href="#eighth-section" className="bebas sidebar-item">Recipes</a>
            </li>
            <li>
              <a href="#ninth-section" className="bebas sidebar-item">Our mixologists</a>
            </li>
          </ul>
        ...
        <header id="header-section">
          ...
          <ul>
            <li>
              <a href="#second-section" className="bebas">Our Master Blender</a>
            </li>
            <li>
              <a href="#fourth-section" className="bebas">Products</a>
            </li>
            <li>
              <a href="#sixth-section" className="bebas">Grain To Glass</a>
            </li>
            <li>
              <a href="#eighth-section" className="bebas">Recipes</a>
            </li>
            <li>
              <a href="#ninth-section" className="bebas">Our mixologists</a>
            </li>
          </ul>
          ...
          <div className="home-container">
            ...
            <div className="content container lazy">
              <div className="text-section">
                <h1 className="gothic text-white common-heading-1">CRAFTED FROM NATURE
                  <span className="leaf position-relative"><img className="position-absolute" src="assets/images/leaf.svg"
                    alt="leaf" /></span>
                </h1>
            ...
            <div className="popup">
              <div className="popup-container">
                ...
                <div className="popup-bottom">
                  <p className="roboto">Home delivery of alcohol products is only applicable in West Bengal and Odisha.</p>
                </div>
              </div>
            </div>
        ...
        <section id="second-section" data-bg='assets/images/greenbg.svg' className="section common-section common-bg lazy">
          <div className="container">
            <div className="second-container">
              <div className="row">
                <div className="col-xl-5">
                  <div className="left position-relative wow fadeInDown" data-wow-duration="2s" data-wow-delay="0.1s">
                    <h2 className="gothic text-lightgreen common-heading-1">the signature of our master blender </h2>
                      ...
                      <div className="item">
                        <div className="img-container-2">
                          ...
                          <img src="assets/images/carousel-2-middle.webp" alt="img" data-animation-in="fadeInRight"
                            data-animation-out="animate-out fadeOutLeft" />
                          <video className="bottom-left opacity-75" autoPlay muted loop playsInline
        ...
        <section id="third-section" className="section common-section">
          ...
          <div className="container">
            <div className="third-container">
              <h2 className="gothic text-lightgreen common-heading-1">Born of craft</h2>
        ...
        <section id="fourth-section" data-bg='assets/images/greenbg.svg' className="lazy section common-section common-bg">
          <div className="container">
              ...
              <div className="row">
                ...
                <div className="col-xl-6">
                  <div className="right wow fadeInUp" data-wow-duration="2s">
                    <h2 className="gothic text-lightgreen common-heading-1">signature premier whisky</h2>
                    <span className="din text-orangish text-uppercase">Smooth & Creamy</span>
                    <p className="text-whitealter common-p">Signature Premier Whisky Gives a perfect smooth and creamy taste
        ...
        <section id="fifth-section" data-bg='assets/images/greenbg.svg' className="lazy section common-section common-bg">
          <div className="container">
            <div className="fifth-container">
              <div className="row">
                <div className="col-xl-6 order-xl-1 order-2">
                  <div className="left wow fadeInUp" data-wow-duration="2s">
                    <h2 className="gothic text-lightgreen common-heading-1">signature rare aged whisky</h2>
                    <span className="din text-orangish text-uppercase">deep & rich</span>
                    <p className="common-p text-whitealter">Signature Rare Whisky gives a perfect Taste that’s DEEP & RICH An
        ...
        <section id="sixth-section" data-bg='assets/images/greenbg.svg' className="lazy section common-section common-bg">
          ...
          <div className="container position-relative">
            ...
            <div className="sixth-container wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="0.2s">
              ...
              <p className="roboto common-p text-whitealter">From
          ...
          <div className="container">
            <div className="seventh-container position-relative">
              ...
              <div className="content wow fadeInUpBig" data-wow-duration="2s">
                ...
                <p className="roboto common-p text-whitealter">Experience the beauty of nature in every sip with these special
        ...
        <section id="eighth-section" data-bg='assets/images/eighthbg.svg' className="lazy section common-section">
          <div className="tab-section">
            <div className="nav nav-tabs tabs" id="nav-tab" role="tablist">
              <button className="tab-button bebas active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#tab-1"
                type="button" role="tab" aria-selected="true">Signature Serve</button>
              <button className="tab-button bebas" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#tab-2"
                type="button" role="tab" aria-selected="false">Region Inspired</button>
              <button className="tab-button bebas" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#tab-3"
                  ...
                  <div className="col-md-8">
                    <div className="modal-right">
                      ...
                      <div className="modal-heading">
                        <h3 className="text-greenish gothic common-heading-1">signature <br className="breaks" /> premier </h3>
                      </div>
                      <div className="modal-para">
                        <p className="roboto700 text-greenish common-p">GT Sour is a depiction of that strong cumin element in a
                          sour with the fine full bodied "Signature Premier" defining the versatile classNameic cocktail of the
                          century.</p>
                      </div>
                      <div className="line bg-greenish"></div>
                      <ul className="modal-recipe-container">
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">60 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Signature</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">15 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Roasted Cumin Cordial</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">3 <span className="roboto">drops</span></div>
                          <p className="name common-p text-greenish">Aromatic Bitters</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">15 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Fresh Lime juice</p>
                        </li>
                        <li className="recipe-method">
                          <p className="common-p roboto700 text-greenish">Method – Shaken with ice and served straight or on the
                            rocks.</p>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <div className="modal-right">
                      ...
                      <div className="modal-heading">
                        <h3 className="text-greenish gothic common-heading-1">signature <br className="breaks" /> rare </h3>
                      </div>
                      <div className="modal-para">
                        <p className="roboto700 text-greenish common-p">Signature paired with the two most iconic flavours of
                      ...
                      <ul className="modal-recipe-container">
                        ...
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">10 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Coffee</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">30 <span className="roboto">ml</span></div>
                        ...
                        <li className="recipe-method">
                          <p className="common-p roboto700 text-greenish">Method – Shaken with ice and served straight.</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <div className="modal-right">
                      ...
                      <div className="modal-heading">
                        <h3 className="text-greenish gothic common-heading-1 changed-heading"> Filter <br className="breaks" />
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <div className="modal-right">
                      ...
                      <div className="modal-heading">
                        <h3 className="text-greenish gothic common-heading-1 changed-heading"> The <br className="breaks" />
                          Signature <br className="breaks" /> Cutting <span>(west)</span>
                        </h3>
                      </div>
                      <div className="modal-para">
                        <p className="roboto700 text-greenish common-p">A refreshing end to the weekend with Signature pairing
                      ...
                      <ul className="modal-recipe-container">
                        ...
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">10 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Black masala tea</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">30 <span className="roboto">ml</span></div>
                        ...
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">10 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Touch of jaggery</p>
                        </li>
                        <li className="recipe-method">
                          <p className="common-p roboto700 text-greenish">Method – Shaken with ice and served straight.</p>
                        </li>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <div className="modal-right">
                      ...
                      <div className="modal-heading">
                        <h3 className="text-greenish gothic common-heading-1">Salty <br className="breaks" /> bay </h3>
                      </div>
                      <div className="modal-para">
                        <p className="roboto700 text-greenish common-p">Complementing the fine aromas is the salty sweet syrup
                      ...
                      <ul className="modal-recipe-container">
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">60 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Signature Premier</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">10 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Himalayan Pink Salt & Palm CandySyrup</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">30 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Bay Leaf Water</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">10 <span className="roboto">ml</span></div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <div className="modal-right">
                      ...
                      <div className="modal-heading">
                        <h3 className="text-greenish gothic common-heading-1">East India <br className="breaks" /> Julep </h3>
                      </div>
                      <div className="modal-para">
                        <p className="roboto700 text-greenish common-p">The flavours of east in west. Kaffir lime &amp; mint
                      ...
                      <ul className="modal-recipe-container">
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">45 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Signature Premier</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">10 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Mint cordial</p>
                        </li>
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">10 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Fresh lime juice</p>
                        ...
                        <li className="modal-recipe">
                          <div className="quantity text-greenish gothic">90 <span className="roboto">ml</span></div>
                          <p className="name common-p text-greenish">Soda</p>
                        </li>
                        <li className="recipe-method">
                          <p className="common-p roboto700 text-greenish">Method – muddled and built over ice in a tall hi ball
          ...
          <div className="tab-content tab-container" id="nav-tabContent">
            <div className="tab-pane active show wow fadeInRight" data-wow-duration="2s" id="tab-1" role="tabpanel"
                    ...
                    <div className="col-lg-6">
                      <div className="carousel-right">
                        <div className="carousel-content">
                          ...
                          <h3 className="text-greenish gothic common-heading-1">signature <br className="breaks" /> premier </h3>
                          <p className="roboto700 text-greenish common-p">Crafted from earth-friendly methods, this whiskey
                            unveils a harmonious blend of nature's abundance and silky elegance. </p>
                          <button className="bebas text-lightgreen bg-deepgreen common-btn" data-bs-toggle="modal"
                    ...
                    <div className="col-lg-6">
                      <div className="carousel-right">
                        <div className="carousel-content">
                          ...
                          <h3 className="text-greenish gothic common-heading-1">signature <br className="breaks" /> rare </h3>
                          <p className="roboto700 text-greenish common-p">Signature Rare reveals an unmistakable depth,
                            weaving
                    ...
                    <div className="col-lg-6">
                      <div className="carousel-right">
                        <div className="carousel-content">
                          ...
                          <p className="roboto700 text-greenish common-p">Signature paired with the two most iconic flavours
                            of
                            coffee & coconut along with just the right amount of soda!</p>
                          <button className="bebas text-lightgreen bg-deepgreen common-btn" data-bs-toggle="modal"
                    ...
                    <div className="col-lg-6">
                      <div className="carousel-right">
                        <div className="carousel-content">
                          ...
                          <p className="roboto700 text-greenish common-p">Taste of Maharashtra with the famous masala tea
                    ...
                    <div className="col-lg-6">
                      <div className="carousel-right">
                        <div className="carousel-content last">
                          ...
                          <h3 className="text-greenish gothic common-heading-1">Salty <br className="breaks" /> bay </h3>
                          <p className="roboto700 text-greenish common-p">Complementing the fine aromas is the salty sweet
                            syrup
        ...
        <section id="ninth-section" data-bg='assets/images/mixologistbg.svg' className="lazy section common-section">
          <div className="container">
            <div className="ninth-container">
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="left">
                    <h2 className="gothic text-greenish common-heading-2 text-center">OUR MIXOLOGISTS</h2>
                    <p className="common-p roboto700 text-greenish">Our mixologists elevate libations to liquid art, crafting
          ...
          <div className="container">
            <div className="tenth-container">
              ...
              <div className="remove-effect content wow fadeInUpBig" data-wow-duration="2s">
                ...
                <p className="common-p text-whitealter">We take pride in using thoughtfully sourced, sustainable materials to
